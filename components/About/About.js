import { Text, Flex, Heading, Box, VStack, HStack } from "@chakra-ui/react";
import {
  FullSection,
  ContentConstrainer,
      ...
      >
        <VStack flex="2" direction="column" align="stretch">
          ...
          <Text fontSize="xl">
            ...
            provident sed aliquid ut accusantium deleniti nobis, minus molestias
            praesentium inventore quas incidunt!
          </Text>
        </VStack>
